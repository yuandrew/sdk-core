...
use crate::worker::heartbeat::{ClientIdentity, HeartbeatCallback, HeartbeatMap, SharedNamespaceWorker, WorkerHeartbeatData};
use crate::{
...
impl Worker {
    ...
    // pub(crate) fn add_heartbeat_callback(&self, key: ClientIdentity, hb: HeartbeatCallback) {
    ...
    // TODO: if I pass a closure
    // TODO: STOPPED 7/23/25 - need to figure out how to pass this callback to the SharedNamespaceWorker
